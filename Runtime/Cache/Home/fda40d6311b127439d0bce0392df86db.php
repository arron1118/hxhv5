...
<html>
	<head>
		...
		<title><?php echo systemCache('web_info.store_name');?> - 优质简历</title>
		<!-- <title>优质简历 - <?php echo systemCache('web_info.store_name');?></title> -->
	...
	<body>
		...
		<div class="ny_cen">
			<div class="left">
				...
				<div class="type">
					<a href="/resume/r0t0c0.html" class="on">优质简历</a>
				</div>
				<div class="news">
					<h3>新闻动态</h3>
					<ul>
				...
				<div class="layui-form">
				  <table class="layui-table" lay-size="lg">
					...
					<?php if(is_array($data)): foreach($data as $key=>$v): $one_user = M('admin_users')->field('person')->where(array('id'=>$v['user_id']))->find(); ?>
				      <tr>
						<td><a href="/resume/<?php echo idEncode($v['id']);?>.html" target="_blank"><?php echo str_replace(I('get.wd'),'<font style="color:red;">'.I('get.wd').'</font>',$v['person']);?></a></td>
				        <td><?php echo C('ZZZT_TYPE')[$v['cerstatus']];?></td>
