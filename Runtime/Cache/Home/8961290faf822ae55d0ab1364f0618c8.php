...
<html>
	<head>
		...
		<title><?php echo systemCache('web_info.store_name');?> - 资质需求</title>
		<!-- <title>资质需求 - <?php echo systemCache('web_info.store_name');?></title> -->
	...
	<body>
		...
		<div class="ny_cen">
			<div class="left">
				...
				<div class="type">
					<a href="/zizhi/r0t0c0.html" class="on">资质需求</a>
				</div>
				<div class="news">
					<h3>新闻动态</h3>
					<ul>
				...
				<div class="layui-form">
				  <table class="layui-table" lay-size="lg">
					...
					<?php if(is_array($data)): foreach($data as $key=>$v): $one_user = M('admin_users')->field('person')->where(array('id'=>$v['user_id']))->find(); ?>
				      <tr>
						<td><a href="/zizhi/<?php echo idEncode($v['id']);?>.html" target="_blank"><?php echo str_replace(I('get.wd'),'<font style="color:red;">'.I('get.wd').'</font>',$v['title']);?></a></td>
